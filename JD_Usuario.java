...
public class JD_Usuario extends javax.swing.JDialog {
    ...
    public JD_Usuario(java.awt.Frame parent, boolean modal) {
     ...
     private void atualizarTabela() {
        try {
            List<Usuario> listaUsuarios = new UsuarioDAO().getAll(Usuario.class);

            TableModel tableModelUsuarios = TableModelCreator.createTableModel(Usuario.class, listaUsuarios, null);
    ...
    private void initComponents() {
        ...
        jScrollPane1.setViewportView(tbUsuarioOficial);
